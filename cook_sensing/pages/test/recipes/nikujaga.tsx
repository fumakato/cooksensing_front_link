...
// カレー or 肉じゃがを指定
const recipe = recipeData.recipes.find((r) => r.recipeName === "肉じゃが");
...
// // データ（カレーと肉じゃがは省略。recipeData に元の JSON を埋め込んでください）
// const recipeData = {
//   recipes: [
//     {
//       recipeName: "カレー",
...
//       {recipe.steps.map((step, idx) => {
//         // グラフ用データ：総合評価以外を抽出
//         const filteredEvals = step.evaluations.filter(
//           (e) => e.label !== "総合評価"
//         );

//         const chartData = {
//           labels: filteredEvals.map((e) => e.label),
//           datasets: [
//             {
//               label: `${step.name} の評価`,
//               data: filteredEvals.map((e) => e.value),
...
//         const chartOptions = {
//           responsive: true,
//           indexAxis: "y" as const, // 横棒グラフに変更したい場合は "y"
//           scales: {
//             x: {
//               beginAtZero: true,
//               max: 5,
